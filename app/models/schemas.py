...
class RegionalEvaluationResult(BaseModel):
    current_tier: str  # '地域支援体制加算1', '地域支援体制加算2', '加算なし' など
    is_basic_fee_1: bool
    supply_system_addition_qualified: bool  # 医薬品供給対応体制加算
    infection_enhancement_qualified: bool   # 連携強化加算
    points_earned: int
    tier_statuses: Dict[str, bool]          # 各加算（1〜4）の判定結果
...
class BillingItem(BaseModel):
    ...
    chart_notes: str
    contributes_to_regional_support: Optional[str] = None  # 例: '在宅実績', '麻薬実績', 'かかりつけ実績', '情報提供料実績'
